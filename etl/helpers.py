"""Shared Cypher helpers for health-determinants-kg ETL loaders.
...
@dataclass
class Registry:
    """Memory-based deduplication registry for health determinants KG entities."""

    countries: set = field(default_factory=set)
    regions: set = field(default_factory=set)
    socioeconomic_indicators: set = field(default_factory=set)
    environmental_factors: set = field(default_factory=set)
    nutrition_indicators: set = field(default_factory=set)
    demographic_profiles: set = field(default_factory=set)
    water_resources: set = field(default_factory=set)
    # Edge dedup
    has_indicator: set = field(default_factory=set)
    environment_of: set = field(default_factory=set)
    nutrition_status: set = field(default_factory=set)
    demographic_of: set = field(default_factory=set)
    water_resource_of: set = field(default_factory=set)
    in_region: set = field(default_factory=set)
